 ...
 *
 * Registered globally in server.js so it runs for every request. Records the
 * arrival time, then waits for the response to finish before logging the
 * method, URL, status code, duration, route params, and body to the console.
 */
